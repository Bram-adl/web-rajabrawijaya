  ...
  <div id="faq">
    <div class="container">
      <div class="row-title">
        ...
        <p class="section-subtitle">Pertanyaan yang sering dipertanyakan.</p>
      </div>
...
export default {
  ...
  data: function () {
    return {
      myItems: [
        {
          title: "Apakah ada grup resmi untuk Maba?",
          value:
            "RAJA Brawijaya tidak menyediakan grup resmi, tetapi kamu bisa menanyakan ke bem fakultas untuk bergabung di grup yang disediakan oleh fakultas",
          category: "Umum",
        },
        {
          title: "Kapan PKKMB Akan dilaksanakan?",
          value: "19 - 20 September 2020",
          category: "PKKMB",
        },
        {
          title: "Bagaimana pelaksanaan PKKMB 2020?",
          value:
            "Acara akan dilaksanakan secara online dan peserta mengikutinya melalui daerah masing - masing",
          category: "PKKMB",
        },
      ],
    };
