<template>
  <div class="gallery">
    <div class="container">
      ...
      <div class="row">
        <h2 class="gallery-header">PKKMU Gallery</h2>
        <VueSlickCarousel v-bind="settings">
          <div class="gallery__box" v-for="(image, index) in pkkmu" :key="index">
            <img :src="image" class="gallery__img">
          </div>
        </VueSlickCarousel>
      </div>
      <div class="row">
        <h2 class="gallery-header">PBPK Gallery</h2>
        <VueSlickCarousel v-bind="settings">
          <div class="gallery__box" v-for="(image, index) in pbpk" :key="index">
            <img :src="image" class="gallery__img">
          </div>
        </VueSlickCarousel>
      </div>
      <div class="row">
        <h2 class="gallery-header">OHLKM Gallery</h2>
        <VueSlickCarousel v-bind="settings">
          <div class="gallery__box" v-for="(image, index) in ohlkm" :key="index">
            <img :src="image" class="gallery__img">
          </div>
        </VueSlickCarousel>
      </div>
...
export default {
  ...
  data: () => {
    return {
      ...
      pkkmu: [
        require('@/assets/img/pkkmu/1.jpg'),
        require('@/assets/img/pkkmu/2.jpg'),
        require('@/assets/img/pkkmu/3.jpg'),
        require('@/assets/img/pkkmu/4.jpg'),
        require('@/assets/img/pkkmu/5.jpg'),
        require('@/assets/img/pkkmu/6.jpg'),
        require('@/assets/img/pkkmu/7.jpg'),
        require('@/assets/img/pkkmu/8.jpg'),
        require('@/assets/img/pkkmu/9.jpg'),
        require('@/assets/img/pkkmu/10.jpg'),
        require('@/assets/img/pkkmu/11.jpg'),
        require('@/assets/img/pkkmu/12.jpg'),
        require('@/assets/img/pkkmu/13.jpg'),
        require('@/assets/img/pkkmu/14.jpg'),
        require('@/assets/img/pkkmu/15.jpg'),
        require('@/assets/img/pkkmu/16.jpg'),
        require('@/assets/img/pkkmu/17.jpg'),
      ],
      pbpk: [
        require('@/assets/img/pbpk/1.jpg'),
        require('@/assets/img/pbpk/2.jpg'),
        require('@/assets/img/pbpk/3.jpg'),
        require('@/assets/img/pbpk/4.jpg'),
        require('@/assets/img/pbpk/5.jpg'),
        require('@/assets/img/pbpk/6.jpg'),
        require('@/assets/img/pbpk/7.jpg'),
        require('@/assets/img/pbpk/8.jpg'),
        require('@/assets/img/pbpk/9.jpg'),
        require('@/assets/img/pbpk/10.jpg'),
        require('@/assets/img/pbpk/11.jpg'),
        require('@/assets/img/pbpk/12.jpg'),
        require('@/assets/img/pbpk/13.jpg'),
        require('@/assets/img/pbpk/14.jpg'),
        require('@/assets/img/pbpk/15.jpg'),
      ],
      ohlkm: [
        require('@/assets/img/ohlkm/1.jpg'),
        require('@/assets/img/ohlkm/2.jpg'),
        require('@/assets/img/ohlkm/3.jpg'),
        require('@/assets/img/ohlkm/4.jpg'),
        require('@/assets/img/ohlkm/5.jpg'),
        require('@/assets/img/ohlkm/6.jpg'),
        require('@/assets/img/ohlkm/7.jpg'),
        require('@/assets/img/ohlkm/8.jpg'),
        require('@/assets/img/ohlkm/9.jpg'),
        require('@/assets/img/ohlkm/10.jpg'),
        require('@/assets/img/ohlkm/11.jpg'),
        require('@/assets/img/ohlkm/12.jpg'),
        require('@/assets/img/ohlkm/13.jpg'),
        require('@/assets/img/ohlkm/14.jpg'),
        require('@/assets/img/ohlkm/15.jpg'),
      ],
    }
  }
}
