  ...
  <div class="adhikara">
    <div class="container">
      ...
      <div class="row-content reset-height">
        <div class="article-card" v-for="artikel in artikels" :key="artikel.id">
          <div class="article-card__header">
            <a href="#" class="article-title">{{ artikel.judul }}</a>
          </div>
          <div class="article-card__body">
            <p class="article-desc">{{ artikel.potongan_isi }}...</p>
          </div>
          <div class="article-card__footer">
            <router-link :to="'/baca/' + artikel.id" class="article-label">Baca Sekarang</router-link>
          </div>
        </div>  
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    mounted() {
      axios
        .get('https://rajabrawijaya.ub.ac.id/api/artikel/')
        .then(response => (this.artikels = response.data.data))
    }
  }
</script>
