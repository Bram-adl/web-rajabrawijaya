<template>
  <div class="adhikara">
    <div class="container">
      <div class="row-title">
        <h2 class="section-title">Adhikara Info</h2>
        <p class="section-subtitle">Pengumuman dan berita terbaru terkait RAJA Brawijaya.</p>
      </div>
      <div class="row-content reset-height">
        <div class="article-card">
          <div class="article-card__header">
            <a href="#" class="article-title">Judul Berita</a>
          </div>
          <div class="article-card__body">
            <p class="article-desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed distinctio excepturi eius voluptatem, amet, similique iste impedit voluptates magnam pariatur corporis tempore repellat omnis labore.</p>
          </div>
          <div class="article-card__footer">
            <router-link to="/baca/1" class="article-label">Baca Sekarang</router-link>
          </div>
        </div>
        <div class="article-card">
          <div class="article-card__header">
  ...
  .row-content {
    ...
    .article-card {
      ...
      &__header {
        padding: 16px;
        text-align: center;
        border-bottom: 1px solid #f8f8f267;
      }
      &__body {
        padding: 8px 16px;
        margin: 25px 0;
